...
namespace MyFruits.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            UserManager<MyFruitsUser> userManager,
            SignInManager<MyFruitsUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new MyFruitsUser { UserName = Input.Email, Email = Input.Email };
                var result = await _userManager.CreateAsync(user, Input.Password);
                if (result.Succeeded)
                {
                    user.EmailConfirmed = true; // Ajout de cette ligne
